...
# 最新软件包（适用于openwrt24.10版本）： https://github.com/zhu525/OpenClash-Nikki-passwall-passwall2-and-other-self-extracting-run-packages-suitable-for-OpenWRT/releases
